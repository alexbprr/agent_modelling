;; This file was generated by the Behaviour Composer at modelling4all.org on Fri May 10 03:28:44 UTC 2019
;; The model can be found at http://m.modelling4all.org/m/?frozen=4r7MreJS1F2JOB9FdIlm4h
...
to the-model [ globals-not-to-be-initialised ]
   ...
   create-objects 100
                  [ set kind
                        "Consumidor"
                    initialise-object ]
   ask all-of-kind "Ambiente inicializador"
       [ -CRIA-EMPRESAS-20 ]
   ask all-of-kind "Consumidor"
       [ -JUMP-TO-UNOCCUPIED-LOCATION-IN-REGION-2014
         -SHAPE-4107
         -JUMP-FORWARD-1110
         -CONSOME-62
         -SIZE-1165
         -SETUP-CLIENTE-21
         -COLOR-5748
         -TURN-REPEATEDLY-RANDOMLY-1239 ]
end

to kind-initialisation [ kind-name ]
   if-else ( kind-name = "Empresa" )
           [ -SETUP-EMPRESA-29
             -GANHOS-FISCAIS-10
             -ACQUISICAO-27
             -SHAPE-4106
             -TAMANHO-DINAMICO-7 ]
           [ if-else ( kind-name = "Ambiente inicializador" )
                     [ -CRIA-EMPRESAS-20 ]
                     [ if-else ( kind-name = "Consumidor" )
                               [ -JUMP-TO-UNOCCUPIED-LOCATION-IN-REGION-2014
                                 -SHAPE-4107
                                 -JUMP-FORWARD-1110
                                 -CONSOME-62
...
to -SETUP-EMPRESA-29
   ...
   let ccolor
       color
   ask ( all-others with [ kind = "Empresa" ] )
       [ if ccolor = color
            [ set color
                  ( list random-integer-between 0 255 random-integer-between 0 255 random-integer-between 0 255 ) ] ]
end

to -GANHOS-FISCAIS-10
   do-every ( 1 )
            [ [] ->  let ccolor
                       color
                   let tmoney
                       0
                   ask ( ( all-of-kind "Consumidor" ) with [ color = ccolor ] )
                       [
                         set tmoney
                             tmoney + my-money ]
                   set my-money
...
to -ACQUISICAO-27
   do-every ( 1 )
            [ [] ->  let tmoney
                   ...
                   let tcolor
                       color
                   ask ( ( all-others with [ kind = "Empresa" ] ) in-radius size )
                       [ if my-money < tmoney
                            [ set tcolor
                                  color
                              ask ( ( all-of-kind "Consumidor" ) with [ color = tcolor ] )
                                  [ set color
                                        ccolor ]
                              set color
                                  ccolor ] ] ]
...
to -TAMANHO-DINAMICO-7
   do-every ( 1 )
            [ [] ->  let ccolor
                       color
                   set size
                       ( 2.0 + ( count ( ( all-of-kind "Consumidor" ) with [ color = ccolor ] ) ) / 20 ) ]
end
...
to -JUMP-TO-UNOCCUPIED-LOCATION-IN-REGION-2014
...
to -CONSOME-62
   do-every ( 1 )
            [ [] ->  let quality
                   ...
                   let ccolor
                       color
                   do-for-n ( count ( all-of-kind "Empresa" ) ) ( all-of-kind "Empresa" ) in-radius my-radius [ [] ->  if money >= my-pricetag
                                                                                                                        [ if my-quality > quality
                                                                                                                             [ set quality
                                                                                                                                   my-quality
                                                                                                                               set ccolor
                                                                                                                                   color ] ] ]
...
to -TURN-REPEATEDLY-RANDOMLY-1239
