;; This file was generated by the Behaviour Composer at modelling4all.org on Fri Mar 22 12:51:45 UTC 2019
;; The model can be found at http://m.modelling4all.org/m/?frozen=Ct2ZfuDamYr0lPmYkfj165
...
to -REPLICAÇÃO-39
   ...
   if random-float 1.0 <= ( 0.2 ) 
      [ add-copies 1 ( list 
                   [ [] ->  -TURN-855 ] [ [] ->  -JUMP-FORWARD-1090 ] ) ] 
end

to -INTERACT-WITH-ANOTHER-678
...
to -JUMP-FORWARD-1064
                      ; Jump forward in the direction of my heading.  
   go-forward 1 
end

to -MOVIMENTO-ALEATÓRIO-16
...
to -BUSCA-ALIMENTO-46
                      ; Follow anyone repeatedly. Note can choose a different 'anyone' each time.  
   do-every ( 1 ) 
            [ [] ->  let target 
                       ( other all-individuals with [ grama-of-patch = 0 ] ) 
                   if ( any? target ) 
                      [ -MOVIMENTO-ALEATÓRIO-16 ] ] 
end
