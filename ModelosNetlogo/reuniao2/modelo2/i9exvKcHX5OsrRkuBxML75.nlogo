;; This file was generated by the Behaviour Composer at modelling4all.org on Mon Mar 18 18:31:47 UTC 2019
;; The model can be found at http://m.modelling4all.org/m/?frozen=i9exvKcHX5OsrRkuBxML75
...
to -TURN-822
   ...
   if ( my-energy > 0 ) 
      [ do-every ( 1 ) 
                 [ [] ->  turn-right random-number-between -180 180 ] ] 
end

to -JUMP-FORWARD-1006
